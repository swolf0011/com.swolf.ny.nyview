 ...
 * Created by LiuYi
 */
public class NYWheelView extends View {


    /**
     * Text size 在初始化方法中设置:(int)getResources().getDimension(R.dimen.wheelview_TEXT_SIZE);
     */
    private static int TEXT_SIZE = 40;//不选择中字大小
    /**
     * Text size 在初始化方法中设置:(int)getResources().getDimension(R.dimen.wheelview_TEXT_SIZE);
     */
    private static int VALUE_TEXT_SIZE = 40;//选择中的字的大小
    ...
    // Wheel Values
    private NYArrayWheelAdapter adapter = null;
    ...
    private TextPaint valuePaint;//选择中的字
    /**
     * Current value & label text color
     */
    private static final int VALUE_TEXT_COLOR = Color.BLUE;//选择中的字的颜色
...
//    private GradientDrawable bottomShadow;
    ...
    public int getItemTextLength() {
        return itemTextLength;
    }

    public void setItemTextLength(int itemTextLength) {
        this.itemTextLength = itemTextLength;
    }

    /**
     * Constructor
     */
    public NYWheelView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * Constructor
     */
    public NYWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initData(context);
    }
     ...
     * Constructor
     */
    public NYWheelView(Context context) {
        super(context);
        initData(context);
    }
    ...
    private void initData(Context context) {
        TEXT_SIZE = (int)getResources().getDimension(R.dimen.wheelview_TEXT_SIZE);
        VALUE_TEXT_SIZE =  (int)getResources().getDimension(R.dimen.wheelview_TEXT_SIZE);
     ...
     * @return the adapter
     */
    public NYArrayWheelAdapter getAdapter() {
        return adapter;
    }
     ...
     */
    public void setAdapter(NYArrayWheelAdapter adapter) {
...
//        setBackgroundResource(R.drawable.wheel_bg);
    ...
    private String buildText(boolean useCurrentValue) {
        ...
        for (int i = currentItem - addItems; i <= currentItem + addItems; i++) {
            if (useCurrentValue || i != currentItem) {
                ...
                if (text != null) {
                    if (text.length() > itemTextLength) {
                        text = text.substring(0, itemTextLength);
                    }
    ...
    private int getMaxTextLength() {
        NYArrayWheelAdapter adapter = getAdapter();
        if (adapter == null) {
            return 0;
        }
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        if (maxLength > 0) {
            double textWidth = Math.ceil(Layout.getDesiredWidth("0", itemsPaint)) * 2;
...
//        centerDrawable.draw(canvas);
        ...
        canvas.drawLine(0, center - offset, getWidth(), center - offset, p);// 中间上线
        canvas.drawLine(0, center + offset, getWidth(), center + offset, p);// 中间下线
    }
    ...
    public interface OnWheelChangedListener {
         ...
         */
        void onChanged(NYWheelView wheel, int oldValue, int newValue);
    }
    ...
    public interface OnWheelScrollListener {
         ...
         * @param wheel the wheel view whose state has changed.
         */
        void onScrollingStarted(NYWheelView wheel);
         ...
         * @param wheel the wheel view whose state has changed.
         */
        void onScrollingFinished(NYWheelView wheel);
    }
