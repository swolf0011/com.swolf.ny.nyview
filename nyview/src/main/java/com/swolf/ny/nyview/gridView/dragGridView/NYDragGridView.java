...
public class NYDragGridView extends GridView {
    /**
    ...
    private NYAbsDragGridViewAdapter mDragAdapter;
    private int mNumColumns;
    private int mColumnWidth;
    private boolean mNumColumnsSet;
    private int mHorizontalSpacing;

    public NYDragGridView(Context context) {
        this(context, null);
    }

    public NYDragGridView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NYDragGridView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private Runnable mLongClickRunnable = new Runnable() {
        ...
        public void run() {
            isDrag = true; // 设置可以拖拽
            mVibrator.vibrate(VibrationEffect.createOneShot(50,10)); // 震动一下
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        if (adapter instanceof NYAbsDragGridViewAdapter) {
            mDragAdapter = (NYAbsDragGridViewAdapter) adapter;
        } else {
