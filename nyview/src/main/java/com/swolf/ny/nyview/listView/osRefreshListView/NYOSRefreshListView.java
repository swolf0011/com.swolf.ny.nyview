...
/**
 * 下拉刷新上拉更多ListView
 * 需要上拉刷新功能时，设置OnRefreshListener监听处理刷新的操作，刷新结束时，在UI线程中调用onRefreshComplete结束刷新
 * 不需要刷新功能时，不设置OnRefreshListener即可，已经设置过刷新且需要取消刷新功能时，调用removeOnRefreshListener方法
 * Created by LiuYi
 */
@SuppressLint("InflateParams")
public class NYOSRefreshListView extends ListView implements OnScrollListener {
    ...
    public NYOSRefreshListView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public NYOSRefreshListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        animation = AnimationUtils.loadAnimation(getContext(), R.anim.ny_refresh_listview_pull_loading);
    ...
    private void initFooterView() {
        footerView = (LinearLayout) inflater.inflate(R.layout.ny_refresh_list_footer, null);
        footerCircleView = (NYEmptyCircleView) footerView
                .findViewById(R.id.base_xsp_view_006_refresh_list_header_emptyCircleView);
        footerTipsTextview = (TextView) footerView.findViewById(R.id.base_xsp_view_006_refresh_list_header_tipsTextView);
    ...
    private void initHeaderView() {
        headerView = (LinearLayout) inflater.inflate(R.layout.ny_refresh_list_header, null);
        headCircleView = (NYEmptyCircleView) headerView
                .findViewById(R.id.base_xsp_view_006_refresh_list_header_emptyCircleView);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (loadMoreState != REFRESHING && loadMoreIsRecored && loadMoreState != LOADING) {
                    if (loadMoreState == RELEASE_To_REFRESH) {
                        ...
                        if (((loadMoreStartY - tempY) / RATIO < footContentHeight) && (loadMoreStartY - tempY) > 0) {
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            case RELEASE_To_REFRESH:// 松开刷新
                headTipsTextview.setText(R.string.ny_head_up_update);
                break;
            ...
            case PULL_To_REFRESH:// 下拉刷新
                ...
                headTipsTextview.setText(R.string.ny_head_down_update_str);
                break;
            ...
            case REFRESHING:// 正在刷新
                ...
                headerView.setPadding(0, mPullDownDistance, 0, 0);
                headTipsTextview.setText(R.string.ny_head_waitting_update);
                break;
    ...
    public void onRefreshComplete() {
        String time = getResources().getString(R.string.ny_head_least_update) + new Date().toLocaleString();
    ...
    private void changeFooterViewByState() {
        ...
        if (isLoadMoreAble) {
            switch (loadMoreState) {
                ...
                case RELEASE_To_REFRESH:// 松开刷新
                    footerTipsTextview.setText(R.string.ny_head_up_update);
                    break;
                ...
                case PULL_To_REFRESH:// 上拉刷新
                    ...
                    footerTipsTextview.setText(R.string.ny_footer_up_update);
                    break;
                ...
                case REFRESHING:// 正在刷新
                    ...
                    footerView.setPadding(0, 0, 0, mPullUpDistance);
                    footerTipsTextview.setText(R.string.ny_head_waitting_update);
                    break;
